...
.. note::
       ...
       AKD1000 and AKD1500 reference SoCs.
    ...
    .. tab-item:: Convolutional
        ...
        .. card::
            ...
            **Max Pooling parameters**
            ...
            and a layer with max pooling must be followed by another `Convolutional
        ...
        .. card::
            ...
            **Quantization bitwidth**
            ...
            +---------+-----------+--------------+
            +++++++++
            :octicon:`report;1em;sd-text-warning` While the minimum supported weights bitwidth is 1
            for native learning, CNN2SNN only allows quantization with bitwidth >=2
