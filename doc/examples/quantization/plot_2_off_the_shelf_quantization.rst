...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    '(ReadTimeoutError("HTTPSConnectionPool(host='huggingface.co', port=443): Read timed out. (read timeout=10)"), '(Request ID: e5793f1b-2823-4b14-ba99-3fd939b796a2)')' thrown while requesting HEAD https://huggingface.co/google/mobilenet_v2_1.0_224/resolve/main/tokenizer_config.json
    Retrying in 1s [Retry 1/5].
    /drone/src/examples/quantization/plot_2_off_the_shelf_quantization.py:125: DeprecationWarning: Deprecated since 1.19. Consider using onnx.printer.to_text() instead.
      print(onnx.helper.printable_graph(model_onnx.graph))
    graph main_graph (
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    ================================================
    [224, 224, 3]  [1, 1, 1001]  1          64    
    ________________________________________________

    ________________________________________________________________________________________________________
    Layer (type)                                                         Output shape    Kernel shape     

    ============= SW//mobilenet_v2/conv_stem/first_conv/convolution/Conv-dequantizer (Software) ============
